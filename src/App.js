...
const Header = () => (
  <header className="bg-gray-900 text-white shadow-lg sticky top-0 z-50">
    <div className="container mx-auto px-6 py-2 flex justify-between items-center">
      ...
      <img src="https://i.imgur.com/TDqLduB.jpeg" alt="Logótipo da Seu Moacir Barbearia" className="h-20 w-auto" />
    ...
    <div className="container mx-auto px-6">
      ...
      <div className="flex flex-col md:flex-row items-center gap-12">
        <div className="md:w-1/2">
          ...
          <img src="https://i.imgur.com/NRnTqBq.jpeg" alt="Interior da Barbearia Seu Moacir" className="rounded-lg shadow-xl w-full h-auto object-cover"/>
        </div>
